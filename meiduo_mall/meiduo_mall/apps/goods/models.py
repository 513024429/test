...
class GoodsChannelGroup(BasModel):
    """商品频道组"""
...
class SPUSpecification(BasModel):
    """商品SPU规格"""
...
class SpecificationOption(BasModel):
    """规格选项"""
